...
/* MarkovChain is a pointer to a LinkedList of Nodes (unique words that appear
 * in the text) in the order of which they first appear in the text. Each Node
 * points to a MarkovNode which contains the word itself and a list of
 * MarkovNodeFrequency-ies (a pointer to a MarkovNode (word) that follows the
 * current MarkovNode and the frequency at which this happens). */
